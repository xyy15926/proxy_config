...
function SetHead()
	...
	if &filetype ==# "python"
		...
		call setline(2, "\# ---------------------------------------------------------")
		call setline(3, "\#   Name: " . b:file)
		call setline(4, "\#   Author: " . b:author)
		call setline(5, "\#   Created: " . b:xtime)
		call setline(6, "\#   Updated: " . b:xtime)
		call setline(7, "\#   Description:")
		call setline(8, "\# ---------------------------------------------------------")
	elseif &filetype  ==# "vim"
		call setline(1, "\" ---------------------------------------------------------")
		call setline(2, "\"   Name: " . b:file)
		call setline(3, "\"   Author: " . b:author)
		call setline(4, "\"   Created: " . b:xtime)
		call setline(5, "\"   Updated: " . b:xtime)
	...
	elseif &filetype ==# "markdown" || &filetype ==# "pandoc"
		...
		call setline(5, "tags:")
		call setline(6, "  - ")
		call setline(7, "date: " . b:xtime)
		call setline(8, "updated: ". b:xtime)
